...
public class ScreenShotTestCompare_Bot {
 
    public static void main(String[] args) {
 
        try {
            String image1Location = "C:\\CiviTestScreenshot\\BotScreenshot_ExpectedImage.png"; 
            String image2Location = "C:\\CiviTestScreenshot\\BotScreenshot_ActualImage.png";
