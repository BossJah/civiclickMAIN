...
public class ScreenShotTestCompare_Mid {
 
    public static void main(String[] args) {
 
        try {
            String image1Location = "C:\\CiviTestScreenshot\\MidScreenshot_ExpectedImage.png"; 
            String image2Location = "C:\\CiviTestScreenshot\\MidScreenshot_ActualImage.png";
